...
app.get('/api/analytics', async (req, res) => {
  try {
    ...
    const recentRevenueMap: Record<string, number> = { "Sun": 0, "Mon": 0, "Tue": 0, "Wed": 0, "Thu": 0, "Fri": 0, "Sat": 0 };
    const orderCountMap: Record<string, number> = { "Sun": 0, "Mon": 0, "Tue": 0, "Wed": 0, "Thu": 0, "Fri": 0, "Sat": 0 };
    orders.forEach(o => {
    ...
    orders.forEach(o => {
      ...
      try { parsedItems = (o.items as string[]) || []; } catch(e) {}
